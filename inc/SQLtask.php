...
if($_POST['GetOrder'] and $_POST['Get1'])
{
    switch($_POST['GetOrder'])
    {
        case "cntEachPro":
            ...
            header("Location: ".LINK_HOST."index.php?id=SQLtask&sort=asort");
            exit;
        break;
        case "cntEachNms":
            $_SESSION['SQL'] = "cntEachPro";
            header("Location: ".LINK_HOST."index.php?id=SQLtask&sort=ksort");
            exit;
        break;
        case "dupTsk":
            $_SESSION['SQL'] = "dupTsk";
        ...
        case "more10":
            $_SESSION['SQL'] = "more10";
            header("Location: ".LINK_HOST."index.php?id=SQLtask&sort=asort10");
            exit;
        break;
    }
    //header("Location: ".LINK_HOST."/index.php?id=SQLtask");
...
if($_GET['sort'])
{
    switch($_GET['sort'])
    {
        case 'arsort':
            $_SESSION['SQL'] = "cntEachPro";
            header("Location: ".LINK_HOST."index.php?id=SQLtask&sort=arsort");
            exit;
        break;
        ...
        case 'krsort':
            $_SESSION['SQL'] = "cntEachPro";
            header("Location: ".LINK_HOST."index.php?id=SQLtask&sort=krsort");
        break;    
        case 'ksortDup':
            $_SESSION['SQL'] = "dupTsk";
            header("Location: ".LINK_HOST."index.php?id=SQLtask&sort=ksortDup");
        break;    
    }
}
?>